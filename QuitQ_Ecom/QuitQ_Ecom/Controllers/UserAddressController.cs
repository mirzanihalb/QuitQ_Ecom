...
namespace QuitQ_Ecom.Controllers
{
    ...
    public class UserAddressController : ControllerBase
    {
        ...
        public async Task<IActionResult> UpdateUserAddress([FromBody] UserAddressDTO userAddressDTO)
        {
            try
            {
                var updatedUserAddress = await _userAddressRepo.UpdateUserAddress(userAddressDTO.UserAddressId, userAddressDTO);
        ...
        public async Task<IActionResult> GetUserActiveAddressByUserId(int userId)
        {
            try
            {
                var activeUserAddress = await _userAddressRepo.GetActiveUserAddressByUserId(userId);
