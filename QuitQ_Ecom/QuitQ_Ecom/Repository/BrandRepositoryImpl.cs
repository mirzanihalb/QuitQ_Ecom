...
public class BrandRepositoryImpl : IBrand
{
    ...
    public async Task<BrandDTO> AddBrand(BrandDTO brandDTO)
    {
        ...
        catch (Exception ex)
        {
            ...
            throw new AddBrandException("Error occurred while adding brand.", ex);
        }
    }
    public async Task<bool> DeleteBrand(int brandId)
    {
        ...
        catch (Exception ex)
        {
            ...
            throw new DeleteBrandException($"Error occurred while deleting brand with ID {brandId}.", ex);
        }
    }
    ...
    */
    ...
    public async Task<BrandDTO> GetBrandById(int brandId)
    {
        ...
        catch (Exception ex)
        {
            ...
            throw new GetBrandByIdException($"Error occurred while retrieving brand with ID {brandId}.", ex);
        }
    }

    public async Task<BrandDTO> UpdateBrand(int brandId, brandNameDTO brandDTO)
    {
        try
        {
            var brand = await _context.Brands.FindAsync(brandId);
        ...
        catch (Exception ex)
        {
            ...
            throw new UpdateBrandException($"Error occurred while updating brand with ID {brandId}.", ex);
        }
    }
}
